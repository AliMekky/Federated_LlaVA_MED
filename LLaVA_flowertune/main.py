...
from dataset import get_tokenizer, get_data_module
...
def main(cfg: DictConfig) -> None:
    ...
    # )
    # 
    tokenizer = get_tokenizer(cfg.model.name, cfg.model.model_max_length)
    ...
    print("NUM CPUS:", cfg.client_resources.num_cpus)
    # Start simulation
